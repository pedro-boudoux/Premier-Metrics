...
def create_players_table():
        ...
        try:
            ...
            for _, row in df.iterrows():
                ...
                players_data.append({
                    ...
                    'age': fix_age(row.get('age', '')),
                    'yellow_cards': misc_data.get('yellow_cards', 0),
                    'red_cards': misc_data.get('red_cards', 0)
                })
                player_id += 1
    ...
    # Order columns
    output_cols = ['id', 'first_name', 'last_name', 'nation', 'team', 'positions', 'age', 'yellow_cards', 'red_cards']
