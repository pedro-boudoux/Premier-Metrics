...
export const PlayerProfileCard = ({ playerData, team }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row md:!flex-col gap-4 md:gap-2 items-center md:items-center w-full md:w-auto justify-between md:justify-start">
        ...
        <div className="flex flex-row md:!flex-row gap-2 items-center md:items-center">
          ...
          <img
            ...
            alt={playerData.team}
            className="h-[1.75rem] md:h-[1.75rem] w-auto object-contain"
          />
        </div>
